let jsonUrl = 'https://bibilailai.zhichaoguo.cn/1.1/classes/content?where=%7B%7D&limit=10&order=-createdAt' // 在这修改api
...
function getData() {
  fetch(jsonUrl,{
      headers:{
        ...
        'x-lc-id': "MYNORkzUKDw9pFQQqfP8dXlv-MdYXbMMI",
        'x-lc-sign': "33f30a4b76f008e973567178a89e34e2,1662549908573"
      }
  }).then(res => res.json())
        .then((data) => {

            data = { time: Date.now(), ls: JSON.stringify(data.results) }
